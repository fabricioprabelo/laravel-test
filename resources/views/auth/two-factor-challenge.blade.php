        ...
        <div x-data="{ recovery: false }">
            ...
            <form method="POST" action="{{ route('two-factor.login') }}">
                ...
                <div class="mt-4" x-cloak x-show="recovery">
                    <x-label for="recovery_code" value="{{ __('lang.recovery_code') }}" />
